...
function love.load()
	...
	pack = player:addSlot(newSlot("Back",true,{"large","backpack","satchel","jetpack","canister","tool","slingable"},true))
	...
	bodyexo = complex:addSlot(newSlot("Body external",false,{"armor","jacket","anysize","canister","slingable"},true))
	...
	table.insert(ground,newContainerItem("Spacesuit",{"armor","large"},
		{
			...
			newSlot("Magpad",true,{"tool","small"},false,1),
			newSlot("Magpad",true,{"tool","small"},false,1)
			}
	))
	table.insert(ground,newContainerItem("Bandolier",{"jacket","large"},
		{
			newSlot("Holster",true,{"gun","weapon","small"},true,1),
			newSlot("Loop",true,{"ammunition","small"},false),
			newSlot("Loop",true,{"ammunition","small"},false),
			newSlot("Loop",true,{"ammunition","small"},false)
			}
	))
	...
	table.insert(ground,newContainerItem("Gun Belt",{"belt","large"},
		{
			newSlot("Holster",true,{"gun","weapon","small"},true,1),
			newSlot("Ammopouch",true,{"ammunition","small"},false),
			newSlot("Pouch",true,{"anytype","small"},false,1),
			}
	))
	table.insert(ground,newContainerItem("Toolbelt",{"belt","large"},
		{
			newSlot("Loop",true,{"tool","small"},false,1),
			newSlot("Loop",true,{"tool","small"},false,1),
			newSlot("Loop",true,{"tool","small"},false,1),
			newSlot("Loop",true,{"tool","small"},false,1)
			}
	...
	table.insert(ground,newItem("Laser Rifle",{"large","slingable"},lethalWeapon))
...
function checkAllAreIn(full,sample)
	local allExist = true
